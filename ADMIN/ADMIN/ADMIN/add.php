...
if(isset($_POST['register'])){
      ...
      if($email != $row['email']){
          ...
          mysqli_query($conn,"INSERT INTO admin (employee_no, email, fname, lname, password, initial, code, status) VALUES ('$employee_no', '$email', '$fname', '$lname', '$password', '$initial', '$code', '$status')");  
