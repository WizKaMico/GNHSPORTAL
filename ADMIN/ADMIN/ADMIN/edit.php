...
if(isset($_POST['edit'])){
      ...
      $status =  mysqli_real_escape_string($conn, $_POST['status']);
          ...
          mysqli_query($conn,"UPDATE admin SET employee_no='$employee_no', department='$department', email='$email', fname='$fname', lname='$lname', initial='$initial', status='$status' WHERE user_id = '$user_id'");  
