      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          <li class="active ">
            ...
            <li>
            <a href="index.php?view=ARCHIVESTUDENT">
              <i class="nc-icon nc-users" style="color:#421714;"></i>
              <p style="color:#421714;">Archive Student</p>
            </a>
          </li>
            <li>
            <a href="index.php?view=ARCHIVEADMIN">
              <i class="nc-icon nc-users" style="color:#421714;"></i>
              <p style="color:#421714;">Archive Admin</p>
            </a>
          </li>
            <li>
            <a href="index.php?view=ARCHIVETEACHER">
              <i class="nc-icon nc-users" style="color:#421714;"></i>
              <p style="color:#421714;">Archive Teacher</p>
            </a>
          </li>
          <li>
    ...
    <div class="main-panel">
      ...
      <div class="content">
        <div class="row">
                ...
                <div class="author">
                  <a href="#" style="text-decoration:none;">
                    ...
                    <h5 class="title" style="color:#421714;">
                      ADMIN! <?php echo strtoupper($row['fname']); ?>
                    </h5>
                  </a>
                </div>
              </div>
          ...
          <?php include_once('include/admin_record.php'); ?> 
          <?php }else if($_GET['view'] == 'SCAN'){ ?>
          <?php include_once('include/scan.php'); ?> 
          <?php } else if($_GET['view'] == 'TEACHER') { ?>
          <?php include_once('include/teacher_record.php'); ?> 
          ...
          <?php include_once('include/password.php'); ?> 
          <?php } else if($_GET['view'] == 'CLASS') { ?>
          <?php include_once('include/class.php'); ?> 
          <?php } else if($_GET['view'] == 'MODULE') { ?>
          <?php include_once('include/module.php'); ?> 
          <?php } else if($_GET['view'] == 'ARCHIVESTUDENT') { ?>
          <?php include_once('include/archive_student.php'); ?> 
          <?php } else if($_GET['view'] == 'ARCHIVEADMIN') { ?>
          <?php include_once('include/archive_admin.php'); ?> 
          <?php } else if($_GET['view'] == 'ARCHIVETEACHER') { ?>
          <?php include_once('include/archive_teacher.php'); ?> 
