                ...
                <div class="author">
                  <a href="#" style="text-decoration:none;">
                    ...
                    <h5 class="title" style="color:#421714;">
                      STUDENT! <?php echo strtoupper($row['fname']); ?>
                    </h5>
                  </a>
                </div>
              </div>
                ...
                <div class="button-container">
                  <div class="row">
                    <div class="col-lg-6 col-md-6 col-6 ml-auto">
                      <h5>  <?php echo strtoupper($row['year']); ?><br><small>YEAR:</small></h5>
                    </div>
                    <div class="col-lg-6 col-md-6 col-6 ml-auto mr-auto">
                      <h5>  <?php echo strtoupper($row['employee_no']); ?><br><small>STUDENT NO:</small></h5>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <center>
                <img src="https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=http%3A%2F%2Flocalhost/GNHS/index.php?email=<?php echo $row['email']; ?>%2F&choe=UTF-8" title="STUDENT:<?php echo $row['name']; ?>"/>
                </center>
      </div>
