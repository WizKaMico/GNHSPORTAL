...
if(isset($_POST['register'])){
      ...
      $date_created = date('Y-m-d');
          ...
          mysqli_query($conn,"INSERT INTO admin (employee_no, department, email, fname, lname, password, initial, code, status) VALUES ('$employee_no', '$department', '$email', '$fname', '$lname', '$password', '$initial', '$code', '$status')");  
