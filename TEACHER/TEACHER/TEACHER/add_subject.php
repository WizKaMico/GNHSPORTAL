...
if(isset($_POST['ADD'])){
      ...
      $email = mysqli_real_escape_string($conn, $_POST['email']);
          ...
          mysqli_query($conn,"INSERT INTO assigned_subject (user_id, subject_id, email) VALUES ('$user_id', '$subject_id', '$email')");  

         

 require 'mailler/autoload.php';
    
      $subject = 'GVNHS | SUBJECT ADDED : '.strtoupper($email).' ';
...
<head>
  <meta charset="UTF-8">
  <title>GVNHS | SUBJECT ADDED </title>
