...
<div class="modal fade" id="qr_<?php echo $row['user_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">	
            	<center>
            		<a href="https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=http%3A%2F%2Flocalhost/GNHS/PAGES/STUDENT/index.php?email=<?php echo $row['email']; ?>%2F&choe=UTF-8" download="myimage"><img src="https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=http%3A%2F%2Flocalhost/GNHS/PAGES/STUDENT/index.php?email=<?php echo $row['email']; ?>%2F&choe=UTF-8" title="STUDENT:<?php echo $row['name']; ?>|EMPLOYEENO:<?php echo $row['employee_no']; ?>"/></a>
            		</center>
			</div>
            ...
            <div class="modal-footer">
            	<button type="button" class="btn btn-default" onclick="window.print()">Print QR</button>
                <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancel</button>
            </div>
